...
function playInterval(){
    bannerPlay = setInterval(mySlide, 5000);    
}
  ...
  $('.playbtn').click(function(){
     if($(this).hasClass('ri-pause-line playbtn')){
        $(this).removeClass('ri-pause-line playbtn').addClass('ri-play-fill');
        stopInterval();
     }else{
        $(this).removeClass('ri-play-fill').addClass('ri-pause-line playbtn');
        playInterval();
     } 
  });
